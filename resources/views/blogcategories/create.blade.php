...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('blogcategories.blogcategory.store') }}" accept-charset="UTF-8" id="create_blogcategory_form" name="create_blogcategory_form" class="form-horizontal">
            {{ csrf_field() }}
